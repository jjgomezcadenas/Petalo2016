...
\noindent\textbf{TÍTULO GENERAL DEL PROYECTO COORDINADO:} Desarrollo de un nuevo tipo de aparato PET basado en xenón líquido y compatible con RMN.
\vspace{6pt}
...
\noindent\textbf{TITLE OF THE COORDINATED PROJECT:} Development of a new PET apparatus based on liquid xenon and compatible with NMR
\vspace{6pt}
